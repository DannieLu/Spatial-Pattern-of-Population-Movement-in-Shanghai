...
\begin{document}
	...
	\begin{figure}[!ht]
		...
		\caption{Image Plots by Hour \label{fig:image}}
	\end{figure}
	\begin{figure}[!ht]
		\includegraphics[width=\textwidth]{hist.png}
		\caption{Histograms by Hour \label{fig:hist}}
	\end{figure}
	\begin{figure}[!ht]
		\includegraphics[width=\textwidth]{hist_log.png}
		\caption{Histograms  by Hour \label{fig:lghist}}
	\end{figure}
	...
	\begin{figure}[!ht]
		...
		\caption{Perspective Plot by Hour \label{fig:perp}}
	\end{figure}
	\begin{figure}[!ht]
		\includegraphics[width=\textwidth]{box.png}
		\caption{Boxplots by Hour \label{fig:boxplot}}
	\end{figure}
	\begin{figure}[!ht]
		\includegraphics[width=\textwidth]{qq.png}
		\caption{QQplots by Hour \label{fig:qq}}
	\end{figure}
